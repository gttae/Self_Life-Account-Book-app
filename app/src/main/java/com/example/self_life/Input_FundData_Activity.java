                        ...
                        try {
                            ...
                            if (incomeCategory.equals("")) {
                                ...
                                if(incomeCategory.equals("고 정")){
                                    if(isValidPrice(incomeFundEt.getText().toString())){
                                        kind = "수입";
                                        ...
                                        Toast.makeText(Input_FundData_Activity.this, "금액에는 숫자만 입력해주세요.", Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                                    if(isValidPrice(incomeFundEt.getText().toString())){
                                        kind = "수입";
                        ...
                        try {
                            ...
                            if (expenseCategory.equals("")) {
                                ...
                                if(expenseCategory.equals("고 정")){
                                    if(isValidPrice(expenseFundEt.getText().toString())){
                                        kind = "지출";
                                        String fundName = "고정" + kind;
                                        String fundKey = mDatabaseRef.child("FundData").child(fundName).push().getKey();
